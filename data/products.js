...
//extraInfoHTML method defined here is overriding the method defined in the parent class - Product
    extraInfoHTML(){
      //super.extraInfoHTML(); // -super (previously called the constructor of the parent class inside the child class) can also be used to call the method of the parnet class
      return `
...
// console.log(products);
  ...
  // even if the above class Clothing is empty it still inherits Product class
  /*
